...
class CodeStyleCheckIssues {
    ...
    public static final String LINE_DOCUMENTATION_FORMAT = "Documentation should start with a capital letter and end with `.`, `:`, `,`, `!`, `?` or `>`."
    ...
    public static final String LINE_SINGLE_LINE_COMMENT_FORMAT = "The single line comment should be formatted as `// descriptive comment content`."
    ...
    public static final String LINE_CONSTANT_REQUESTPROPERTIES = "RequestParameters.REQUESTPROPERTIES is designed to replace `requestProperties`."
