...
class CodeStyleCheckIssues {
    ...
    public static final String GLOBAL_BAD_CLASS_NAMING_WITH_PROFILE = "Class name should be like `PhoneValidatorChineseImpl`, `BookingServiceInternationalImpl`, or `CouponServiceTestChineseImpl`."
    ...
    public static final String LINE_REDUNDANT_CODE_DESC = "Comments are only necessary for business descriptions; it`s unnecessary for self-explanatory codes."
    ...
    public static final String LINE_UNIT_TEST_PRIVATE_FIELD = "The field in test class should be private."
    ...
    public static final String LINE_OPTIMIZE_RETURN = "Please optimize multiple `return` into one; sometime ternary operator might be helpful."
