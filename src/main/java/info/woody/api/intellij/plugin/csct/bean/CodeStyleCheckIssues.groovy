...
class CodeStyleCheckIssues {
    ...
    public static final String LINE_CONSTANT_AS_LEFT_OPERAND = "Use the constant as left operand to avoid NullPointerException."
    ...
    public static final String LINE_GROOVY_PUBLIC_IN_FIELD = "Keyword `public` is redundant for non-static fields in Groovy."
